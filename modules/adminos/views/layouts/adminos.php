...
<body>
	...
	<header class="row" id="backg">
		<div class="fons">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<ul id="ul">
						<a href="<?= Url::home() ?>"><li>На сайт</li></a>
						<a href="<?= Url::to(['category/index']) ?>"><li>Главная</li></a>
			            <a href="<?= Url::to(['articles/index']) ?>"><li>Работа со статьями</li></a>
					</ul>
				</div>
			</div>
		</div>
	...
	<footer class="row">
		...
		<div class="col-md-12">
			...
			<div class="col-md-7">
				<ul>
					<li><a href="<?= Url::home()?>">На сайт</a></li>
					<a href="<?= Url::to(['category/index']) ?>"><li>Главная</li></a>
					<li><a href="<?= Url::to(['articles/index']) ?>">Работа со статьями</a></li>
				</ul>
			</div>
			<div class="col-md-3">
				<div id="cont">
